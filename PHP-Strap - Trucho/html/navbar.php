...
echo '
    <nav>
        ...
        <ul id="menu">
            <li><a href="#" onclick="loadPage(\'home\'); return false;" id="nav-home">Inicio</a></li>
            <li><a href="#" onclick="loadPage(\'about\'); return false;" id="nav-about">Acerca de</a></li>
            <li><a href="#" onclick="loadPage(\'contact\'); return false;" id="nav-contact">Contacto</a></li>
